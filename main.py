"""
Данные из файла excel_v.csv обрабатываются, на вход программы поступает профессия или ее часть.
Согласно статистики из csv создается excel и визуализируются данные через matplotlib.
В excel две страницы: статистика по годам и статистика по городам.
Matplotlib выводит четыре графика и сохраняет их в папку с проектом.
"""
import csv
import re
